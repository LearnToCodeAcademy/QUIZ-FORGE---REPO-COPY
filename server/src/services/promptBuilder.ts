...
export function buildGrokSystemPrompt(): string {
  return [
    ...
    "Ensure true_false answer_index is 0 for True or 1 for False.",
...
export function buildGrokUserPrompt(params: {
  ...
  return [
    ...
    "- answer_index must be 0 (True) or 1 (False).",
    "- Prompt should be a clear statement that is either true or false.",
    "- Do not use ambiguous or trick statements.",
    "",
    "FILL BLANK RULES:",
